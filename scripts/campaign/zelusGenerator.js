const zelusGen = extend(PlanetGenerator, {
    rawHeight(position){
    ...
    generate(tiles, sec){
        ...
        const Room = {
            ...
            connect(to){
                ...
                zelusGen.brush(zelusGen.pathfind(this.x, this.y, to.x, to.y, tile => (tile.solid() ? 5 : 0) + zelusGen.noiseOct(tile.x, tile.y, 1, 1, 1 / nscl) * 60, Astar.manhattan), stroke);
            }
        };
        ...
        var difficulty = this.sector.threat*2;
